...
window.onload = function () {
	...
	// BEGIN EXT ADDED
	let stardewPredictorExt = window.stardewPredictorExt ?? null;
	// END EXT ADDED
	...
	function parseSummary(xmlDoc) {
		...
		// BEGIN EXT ADDED
		if (stardewPredictorExt !== null) {
			return stardewPredictorExt.parseSummary(xmlDoc, save, wasChanged);
		}
		// END EXT ADDED
...
//console.log("Rolled " + index + " picking " + vendorPool[index]);
	...
	function updateTab(tabID, isSearch, offset, extra) {
		// BEGIN EXT ADDED
		if (stardewPredictorExt !== null && stardewPredictorExt.updateTab(tabID, isSearch, offset, extra)) {
			return;
		}
		// END EXT ADDED
		var output = '';
	...
	// BEGIN EXT ADDED
	if (stardewPredictorExt !== null) {
		stardewPredictorExt.setBaseUtil({
			addCommas,
			capitalize,
			compareSemVer,
			wikify,
